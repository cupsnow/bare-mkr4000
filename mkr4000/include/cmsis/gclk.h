...
typedef enum {
	MKR4000_GCLK_SRC_XOSC = 0,
	MKR4000_GCLK_SRC_GCLKIN = 1,
	MKR4000_GCLK_SRC_GCLKGEN1 = 2,
	MKR4000_GCLK_SRC_OSCULP32K = 3,
	MKR4000_GCLK_SRC_OSC32K = 4,
	MKR4000_GCLK_SRC_XOSC32K = 5,
	MKR4000_GCLK_SRC_OSC8M = 6,
	MKR4000_GCLK_SRC_DFLL48M = 7,
	MKR4000_GCLK_SRC_FDPLL96M = 8,
} MKR4000_GCLK_SRC_T;

typedef enum {
	MKR4000_GCLK_CLK_DFF48M_REF = 0,
	MKR4000_GCLK_CLK_SERCOM5_CORE = 0x19,
} MKR4000_GCLK_CLK_T;
